...
async function run() {
  ...
  const payload = {
    guess: [218,47,7,62,6,247,137,56,22,111,36,114,115,114,157,254,70,91,247,228,97,5,193,60,231,204,101,16,71,191,12,164],
    day: 1,
    addressIn: address
  };
  ...
  const success = await verifier.verifyProof(
    params[0],
    [
      32, address,
      1, address
