// Generated by @wagmi/cli@1.0.2 on 6/4/2023 at 5:55:56 PM
import {
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link zkWordoABI}__ and `functionName` set to `"createdAt"`.
 */
export function useZkWordoCreatedAt<
  TFunctionName extends 'createdAt',
  TSelectData = ReadContractResult<typeof zkWordoABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof zkWordoABI, TFunctionName, TSelectData>,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link zkWordoABI}__ and `functionName` set to `"day"`.
 */
export function useZkWordoDay<
  TFunctionName extends 'day',
  TSelectData = ReadContractResult<typeof zkWordoABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof zkWordoABI, TFunctionName, TSelectData>,
